#https://github.com/langchain-ai/langchain/blob/d00a247da7cc49af5f646be09796401d5026884c/libs/langchain/langchain/llms/huggingface_pipeline.py#L18

# python -m convert --quantize --model_id flan-t5-small --task text2text-generation
# https://pypi.org/project/optimum/
# https://github.com/xenova/transformers.js/blob/main/scripts/convert.py
# https://github.com/xenova/transformers.js/

# https://huggingface.co/spaces/HuggingFaceH4/open_llm_leaderboard?ref=axion.zone
